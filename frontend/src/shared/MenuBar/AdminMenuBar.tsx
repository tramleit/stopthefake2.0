...
const AdminMenuBar: React.FC<AdminMenuBarProps> = () => {
  ...
  //       <Dialog
  //         as="div"
  //         className="inset-0 z-50 overflow-y-auto"
  //         onClose={handleCloseMenu}
  //       >
  //         <div className="w-full md:w-auto z-max outline-none focus:outline-none">
  //           <React.Fragment>
  //             <Transition.Child
  //               as={Fragment}
