...
export default function AvatarDropdown2({ user, logout }: any) {
  return (
          ...
          <>
            ...
            >
              <h5
                ...
                className="md:flex hidden align-center"
              >
                <span>{user?.name || "Eden Tuan"}</span>{" "}
                <ChevronDownIcon
                  className="ml-2 h-4 w-4 text-neutral-500 mt-1"
                  aria-hidden="true"
                />
              </h5>
              <Avatar
                imgUrl={
                  user?.image
                    ? isURL(user?.image)
                      ? user.image
                      : `http://localhost:8000/assets/avatars/${user?.image}`
                    : avatarImgs[7]
                }
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-xs mt-0.5">{user?.credits} Token</p>
                      </div>
                    </div>
